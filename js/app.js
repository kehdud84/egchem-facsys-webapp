...
const ALL_SCREENS = [
    'mode-screen', 'process-screen', 'product-entry-screen',
    'run-screen', 'run-lot-screen', 'main-screen',
...
// openProductEntry()는 js/process.js에, openProcessRun()은 js/run.js에 있다.
// (둘 다 app.js보다 먼저 실행되므로, 여기에 같은 이름을 두면 그쪽이 덮인다)
